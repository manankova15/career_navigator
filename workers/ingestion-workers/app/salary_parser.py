...
def _maybe_scale_from_to(
    ...
    """
    «Подтягиваем» множитель с верхней границы на нижнюю, если только у to
    указан, например, "k", а у from — нет ("100-200k руб" => 100000-200000).
    Также обрабатываем "55 - 90 000 GBP" => 55000-90000.
    """
